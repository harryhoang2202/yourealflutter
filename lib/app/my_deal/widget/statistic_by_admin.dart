...
class StatisticByAdmin extends StatefulWidget {
  const StatisticByAdmin({Key? key}) : super(key: key);

  @override
  _StatisticByAdminState createState() => _StatisticByAdminState();
}

class _StatisticByAdminState extends State<StatisticByAdmin> {

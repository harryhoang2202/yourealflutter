...
class WDealInvesting extends StatelessWidget {
  const WDealInvesting({super.key});
      ...
      child: Column(
        children: [
          ...
          BlocSelector<HomeBloc, HomeState, List<Deal>>(
            selector: (state) {
              return state.investedDealState.data;
            },
            builder: (context, data) {
              return BlocBuilder<HomeBloc, HomeState>(
                builder: (context, state) {
                  ...
                  if (state.investedDealState.data.isEmpty) {
                    return Container(

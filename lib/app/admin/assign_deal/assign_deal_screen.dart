...
import 'bloc/assign_deal_bloc.dart';

class AssignDealScreen extends StatefulWidget {
  const AssignDealScreen({super.key});

  @override
  State<AssignDealScreen> createState() => _AssignDealScreenState();
}

class _AssignDealScreenState extends State<AssignDealScreen> {
  final DateFormat dateFormat = DateFormat("yyyyMMddHHmmss");
  late final AssignDealBloc bloc;

  final RefreshController _refreshController =
      RefreshController(initialRefresh: false);

  void _onRefresh() async {
    bloc.add(const AssignDealEvent.loadDeal());
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        BlocConsumer<AssignDealBloc, AssignDealState>(
                          bloc: bloc,
                          ...
                          buildWhen: (previous, current) =>
                              current is AssignDealLoaded ||
                              current is AssignDealInitial,
